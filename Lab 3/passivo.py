...
def adicionaChaveServ(chave, valor):
    ...
    while True:
        ...
        for pronto in leitura:
            if pronto == sock:  #pedido novo de conexao
                ...
                elif cmd == 'look': #ta dandoi erro
                    x = input("Digite a palavra a se procurar: ")
                    printaChaveServ(x)
                elif cmd == 'write':
                    x = input("Digite a palavra a ser adicionada: ")
                    valor = input("Digite a definicao da palavra: ")
                    adicionaChaveServ(x, valor)
                elif cmd == 'remove':
                    x = input("Digite a palavra a ser removida: ")
                    removeChaveServ(x)
